...
def ComputeSSD(TODOPatch, TODOMask, textureIm, patchL):
	...
	for r in range(ssd_rows):
		for c in range(ssd_cols):
			...
			# TODOMask: specifies the elements of which elements of TODOPatch are 
			# empty and waiting to be filled in. A 1 represents an empty pixel.
...
def CopyPatch(imHole,TODOMask,textureIm,iPatchCenter,jPatchCenter,iMatchCenter,jMatchCenter,patchL):
	...
	for i in range(patchSize):
		for j in range(patchSize):
			...
			# holeLocation: the area to be filled
			# textureLocation: the area of texture
			if TODOMask[i][j] == 1:
...
im = Image.open('/Users/zhangquan/Documents/CS425/hw3/assign2/2(1).jpg').convert('RGB')
...
if os.path.isfile('/Users/zhangquan/Documents/CS425/hw3/assign2/fill_region.pkl') and os.path.isfile('/Users/zhangquan/Documents/CS425/hw3/assign2/texture_region.pkl'):
	fill_region_file = open('/Users/zhangquan/Documents/CS425/hw3/assign2/fill_region.pkl', 'rb')
	fillRegion = pickle.load( fill_region_file )
	fill_region_file.close()

	texture_region_file = open('/Users/zhangquan/Documents/CS425/hw3/assign2/texture_region.pkl', 'rb')
...
while (nFill > 0):
	print ("Number of pixels remaining = ")
	print (nFill)
