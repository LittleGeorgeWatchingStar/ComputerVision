...
train_image_paths, train_labels= sample_images("/Users/zhangquan/Desktop/hw5/sift/train", n_sample=300)
test_image_paths, test_labels = sample_images("/Users/zhangquan/Desktop/hw5/sift/test", n_sample=100)
...
knn_correct = np.mean(pred_labels_knn == test_labels)
svm_correct = np.mean(pred_labels_svm == test_labels)

print("KNN Accuracy =", knn_correct / len(test_labels))
print("SVM Accuracy =", svm_correct / len(test_labels))
knn_cm = generate_confusion_matrix(test_labels, pred_labels_knn, test_labels, "KNN")
svn_cm = generate_confusion_matrix(test_labels, pred_labels_svm, test_labels, "SVM")
